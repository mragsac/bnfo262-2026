...
1. Navigate to the IGV [download page](https://software.broadinstitute.org/software/igv/download) and choose the download method depending if you're a Mac or Windows user (we want to have a local version). You may need to install Java if you do not have it already (follow instructions on IGV link).
2. The download might take a few minutes so be patient.
3. Unzip IGV and place it in a meaningful location (can be a BNFO262/BIOM262/BGGN237 class folder but I recommend moving it to a more meaningful/accessible location).
